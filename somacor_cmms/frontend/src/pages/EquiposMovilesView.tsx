...
const EquiposMovilesView = () => {
    ...
    const columns = [
        ...
        // Usa una función para mostrar el nombre anidado o 'N/A' si no existe
        { header: 'Faena', accessor: (item) => item.idfaenaactual?.nombrefaena || 'N/A' },
        { header: 'Estado', accessor: (item) => item.idestadoactual?.nombreestado || 'N/A' },
    ...
    useEffect(() => {
        const fetchRelatedData = async () => {
            ...
            try {
                ...
                const [tiposRes, faenasRes, estadosRes] = await Promise.all([
                ...
                const fields = [
                    ...
                    { name: 'aniofabricacion', label: 'Año de Fabricación', type: 'number' },
                    { 
                        name: 'idtipoequipo', 
                    ...
                    { name: 'horometroactual', label: 'Horómetro Actual', type: 'number', defaultValue: 0 },
